...
export function OnboardingModal({ onSelect }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
      <div className="w-full max-w-2xl rounded-xl border border-emerald-700/50 bg-[#0b100e] shadow-[0_0_40px_rgba(16,185,129,0.15)] flash-in">
        <div className="border-b border-emerald-900/40 px-6 py-4">
          <p className="text-[11px] font-mono text-emerald-600 mb-1">
            $ onboarding --init
          </p>
          <h1 className="text-lg font-semibold text-emerald-300 font-mono">
            Welcome to DS4All
          </h1>
          ...
          {levels.map((key) => {
            ...
            return (
              <button
                ...
                className="group text-left rounded-lg border border-emerald-900/50 bg-emerald-950/20 p-4 transition-all hover:border-emerald-500/70 hover:bg-emerald-900/30 hover:shadow-[0_0_20px_rgba(16,185,129,0.2)] focus:outline-none focus:border-emerald-500/70"
              >
                ...
                <ul className="space-y-1">
                  {PERKS[key].map((perk) => (
                    <li key={perk} className="text-[10px] text-emerald-500 flex gap-1.5">
        ...
        <div className="border-t border-emerald-900/40 px-6 py-3">
